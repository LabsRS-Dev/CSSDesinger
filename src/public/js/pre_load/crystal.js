(function (Crystal) {
    (function () {
        var Application, Attributes, Bindings, Color, Keyboard, List, Logging, MVC, Model, ModelView, NWDialogs, NWFile, SPECIAL_KEYS, Store, Types, Unit, Utils, css, i18n, key, method, methods, methods_element, methods_node, olds, prefixes, properties, types, value, _find, _parseName, _ref, _wrap,
        ...
        window.NWDialogs = new (NWDialogs = (function () {
            ...
            NWDialogs.prototype.save = function (callback) {
                ...
                this.input.setAttribute('nwsaveas', 'designerFile.css');
        ...
        window.Keyboard = Keyboard = (function () {
            ...
            Keyboard.prototype.handleKeydown = function (e) {
                var combo, delimeters, pressed, sc, _i, _len, _ref, _results;
                delimeters = /-|\+|:|_/g;
                if (!e.cancelled) {
                    combo = [];
                    if (e.ctrlKey) {
        ...
        window.ModelView = ModelView = (function () {
            ...
            function ModelView(model, view) {
                var args, binding, fn, fninit, selector, _ref, _ref1, _ref2;
                this.model = model;
                this.view = view;
                this.__bindings__ = [];
                _ref = this.bindings;
                for (key in _ref) {
                    ...
                    _ref1 = key.split('|'), selector = _ref1[0], binding = _ref1[1];
            ...
            ModelView.prototype.render = function () {
                var args, binding, bobj, fn, selector, _i, _len, _ref, _results;
                _ref = this.__bindings__;
                _results = [];
                for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                    bobj = _ref[_i];
        ...
        // 修正错误：DocumentFragment .children undefined
        try{
            ...
            WebSQL.prototype.list = function (callback) {
                ...
                return this.exec("SELECT key FROM store", function (tr, results) {
                    ...
                    if (results.rows.length > 0) {
                        (function () {
                            _results = [];
                            for (var _i = 0, _ref1 = results.rows.length - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; 0 <= _ref1 ? _i++ : _i--) {
                                _results.push(_i);
                            }
                            return _results;
